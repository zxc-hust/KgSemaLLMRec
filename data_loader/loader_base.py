...
#         # pretrain_path = '/data/zou/KGAT-pytorch-master/datasets/pretrain/amazon-book/llm_emb.npz'
#         # pretrain_data = np.load(pretrain_path)
#         # self.item_pre_embed = pretrain_data['item_embed']
#         # self.user_pre_embed = None
#     def load_llm_emb(self):
#         llm_emb_path = '%s/%s.npy' % (self.llm_embedding_dir, 'llm_emb')
