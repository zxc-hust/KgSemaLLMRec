...
class DataLoaderKGAT(DataLoaderBase):
    ...
    def construct_data(self, kg_data):
        ...
        # for row in tqdm(self.kg_train_data.iterrows(), 
        ...
        # 定义保存路径
        save_path = "/data/zou/KGAT-pytorch-master/datasets/amazon-book/kg_data.pkl"
        ...
        if os.path.exists(save_path):
            ...
            with open(save_path, 'rb') as f:
                ...
                self.h_list = saved_data['h_list']
                self.t_list = saved_data['t_list']
                self.r_list = saved_data['r_list']
                self.train_kg_dict = saved_data['train_kg_dict']
                self.train_relation_dict = saved_data['train_relation_dict']
        else:
            # 如果不存在，处理数据并保存
            h_list = []
            t_list = []
